        ...
        <div v-if="editingPost" class="form">
            <div class="form-group">
                <div class="label-row">
                    ...
                    <span class="char-count" :class="{ over: isTitleOver }"
                ...
                />
                <p v-if="isTitleOver" class="form-error">
            ...
            <div class="form-group">
                ...
                <p v-if="isContentOver" class="form-error">
            ...
            <div class="form-group">
                <div class="label-row">
                    ...
                    <span class="char-count" :class="{ over: isTagsOver }"
                        >{{ tags.length }}/5</span
                    >
                </div>
                ...
                <p v-if="isTagsOver" class="form-error">
                    You can add at most 5 tags
                </p>
                <p v-if="isTagInputOver" class="form-error">
                    Tag cannot exceed 10 characters
                </p>
            </div>

            <div class="form-actions">
                <el-button size="large" class="cancel-btn" @click="cancelEdit"
                    >Cancel</el-button
                >
                <el-button
                    size="large"
...
const isTagInputOver = computed(
    () => tagInput.value.trim().length > MAX_TAG_LENGTH,
);
const canAddTag = computed(
    () =>
        !!tagInput.value.trim() &&
        tags.value.length < MAX_TAGS &&
        !isTagInputOver.value,
);
...
const titleChanged = computed(
    () => title.value.trim() !== originalTitle.value.trim(),
);
